...
public class GameplayController : MonoBehaviour {
	...
	public void IncreaseScore() {
		zombie_Kill_Count++;
		score_Text.text = "Kills : "+zombie_Kill_Count.ToString ();
        if(zombie_Kill_Count > PlayerPrefs.GetInt("HighScore"))
        {
            if (canCongrates)
            {
                
                Congrates_Panel.SetActive(true);
                anim = GameObject.Find("text").GetComponent<Animator>();
                anim.Play("Congrats Text");
                canCongrates = false;
            }
	...
	public void Gameover() {
        ...
        if(zombie_Kill_Count > PlayerPrefs.GetInt("HighScore"))
        {
            ...
            PlayerPrefs.SetInt("HighScore", zombie_Kill_Count);
